...
<p align="center">
  ...
  <br>🎯 Currently learning through <a href="https://www.theodinproject.com/" target="_blank">The Odin Project</a>  
  <br>⚡ Focused on mastering HTML, CSS, and JavaScript  
  <br>🖥️ Enthusiastic <b>homelabber</b> running self-hosted applications with <b>Docker</b>  
  <br>🚀 Passionate about crafting responsive, fast, and visually engaging web experiences
</p>
...
- 🌤️ [**Weather App**](link) – a dynamic weather application
- 🎨 [**Etch a Sketch**](link) – an interactive drawing canvas
- 🧮 [**Calculator**](link) – a functional calculator application
- ✅ [**To Do App**](link) – a task management application
